...
//   useEffect(() => {
//     if (isPlaying || isMobileFullscreen) {
...
//       }
//     };
//   }, [isPlaying, isMobileFullscreen, isVideoPlaying, isMuted, currentTime]);
...
//     };
//   }, [isPlaying, isMobileFullscreen]);

//   // ---- Handlers ----
//   const handleOpen = () => {
//     if (isMobile) {
//       // For mobile, just play in the same container
...
//   const handleClose = () => {
//     if (isMobile) {
//       // For mobile, just pause and reset
...
//         handleClose();
//       }
//       if (e.key === " " && (isPlaying || isVideoPlaying)) {
//         e.preventDefault();
//         handlePlayPause();
//       }
//       if (e.key === "m" && (isPlaying || isVideoPlaying)) {
//         handleMute();
//       }
//     };
...
//       {isMobile && (
//         <div className={`relative z-10 w-[90%] mx-auto max-w-3xl aspect-video bg-black ${isMobileFullscreen ? 'fixed inset-4 z-50 w-auto h-auto' : ''}`}>
//           <video
//             ref={mobileVideoRef}
//             className="w-full h-full object-cover rounded-lg shadow-lg"
//             src="/hero-video.mp4"
...
//           {/* Mobile overlay when not playing */}
//           {!isVideoPlaying && (
//             <div className="absolute inset-0 flex items-center justify-center bg-black/30 rounded-lg">
//               <SmallTile name="Play Video" onClick={handleOpen} />
//             </div>
//           )}

//           {/* Mobile controls when playing */}
//           {isVideoPlaying && showControls && (
//             <div 
//               className="absolute bottom-4 left-4 right-4 flex flex-wrap items-center justify-between gap-2"
...
//           {!isVideoPlaying && !showControls && isVideoPlaying !== null && (
//             <div 
